...
public class Demo03 {
	...
	public static void main(String[] args) throws Exception {
		...
		Class<?> c = loader.loadClass("com.HelloWorld");
		Class<?> c2 = loader.loadClass("com.HelloWorld");
		Class<?> c3 = loader2.loadClass("com.HelloWorld");

		Class<?> c4 = loader2.loadClass("java.lang.String");
		Class<?> c5 = loader2.loadClass("com.jvm.Demo01");
