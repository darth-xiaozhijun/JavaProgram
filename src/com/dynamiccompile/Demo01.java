...
public class Demo01 {
	...
	public static void main(String[] args) throws Exception {
		...
		String str = "public class Hi {public static void main(String[] args){System.out.println(\"HaHa,world!\");}}";
		
		JavaCompiler compiler = ToolProvider.getSystemJavaCompiler();
		int result = compiler.run(null, null, null, "D:/workspace/xiaozhijun/JavaProgram/src/com/dynamiccompile/compile/HelloWorld.java");
